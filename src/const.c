 ...
 */
    ...
    {
        "amazonbless",             12,
        spell_amazonbless,         TAR_CHAR_DEFENSIVE,     POS_STANDING,
        NULL,                   SLOT(205),      5,      12,
        "",                     "You feel Artemis's blessing leave you."
    },
    {
        "forcebless",             12,
 ...
 */
...

   {
	...
	&gsn_kick,		SLOT( 0),	 0,	 PULSE_VIOLENCE,
	"kick",			"!Kick!"
    },
	...
	"pick lock",		1,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	&gsn_pick_lock,		SLOT( 0),	 0,	PULSE_VIOLENCE/2,
	"",			"!Pick!"
    },
 ...
 */
    ...
    {   "BazmaPunch",		99,
	spell_null,		TAR_IGNORE,	POS_FIGHTING,
	NULL,			SLOT( 0),	0, PULSE_VIOLENCE/1.5,
	"Super Bazma Punch",	""
    },
...
/* mech shit */
 ...
 {
        "clusterbomb",        65,
        spell_clusterbomb,    TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
        NULL,                   SLOT(32),       15,     4,
...
/*end of mecha shit*/
	...
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(554),	 100,	12,
	"",			"You feel more comfortable as Satan lifts his magic off of you."
    },
    {
	"Gold Golem",		99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"#3Sharp Golden Slivers#n",""
    },
    {
	"white magic",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(554),	 100,	12,
	"",		"#7You feel god's touch fade away and you want sumore!#n"
    },
    {
	"ram",		99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	...
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"Wind Slash",	"#6You feel the power of the wind fade away.."
    },
    {	"elf fire",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"Elven Fire",	"#1Your blessing of the elven fire fades.."
    },
    {	"Rage",		99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"Rage",		"You begin to feel calmer."
    },
    {	"Sand Blast",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"Sand Blast",	"The sand finally fades away into a small spec of  dust."
    },
    {	"WaterWield",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"WaterWield",	"The waterwield encompasing you fades."
    },
