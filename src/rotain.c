...

{
	...
	send_to_char("*************************************************\n\r", ch);
	sprintf(buf, "Rogue Edition By Listy, Adreno, Chloe and Nuitari\n\r             Version Number : %d\n\r", VERSION_NUMBER);
	send_to_char(buf,ch);
	send_to_char("        Original God Wars Coding by KaVir\n\r", ch);
	send_to_char("      LOW Modifications by Sage and Dunkirk\n\r", ch);
	send_to_char("                 Rogue Credits\n\r", ch);
	send_to_char("   New Fight Code Credits - Nuitari and Listy\n\r", ch);
	send_to_char("  Amazon Class Credits - Chloe, Adreno, Nuitari\n\r", ch);
	send_to_char("           Jedi Class Credits - Listy\n\r", ch);
	send_to_char("        Area Credits - Adreno and Nuitari\n\r", ch);
	send_to_char("   General Bug Fix Credits - Listy and Nuitari\n\r", ch);
	send_to_char("*************************************************\n\r", ch);
...

{
   ...
   if ((ch->vampgen_a>2)&&(ch->vampgen_a!=1))
