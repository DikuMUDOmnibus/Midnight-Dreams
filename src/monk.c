...
return;    
	...
	if (victim->level < 3){send_to_char("God doesn't like that very much!\n\r", ch);return;}if ( ch->move < 250 )	

{	

send_to_char( "You don't have the required 250 move.\n\r", ch);	
...
send_to_char( "You don't have the required 250 mana.\n\r", ch);	
